    ...
    steps: [
      ...
      // ── 5. Превью ──────────────────────────────────────────────────────────
      {
        ...
        popover: {
          ...
          description: ru(
            ...
            '<br>• <b>Ctrl/⌘ + колесо</b> — плавный масштаб; выбери курсор и тяни арт <b>ЛКМ</b>, чтобы перемещаться. ' +
            ...
            '<br>• <b>Ctrl/⌘ + wheel</b> zooms smoothly; choose the cursor and drag with <b>LMB</b> to pan. ' +
      ...
      // ── 6. Панель инструментов ─────────────────────────────────────────────
      {
        ...
        popover: {
          ...
          description: ru(
            '<b>Отменить / Повторить</b> (Ctrl+Z / Ctrl+Y). ' +
