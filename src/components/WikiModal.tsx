    ...
    tools: {
      ...
      content: (
        <div>
          ...
          <h4>Undo / Redo</h4>
          <p>Use Undo (Ctrl+Z) and Redo (Ctrl+Y) for full paint history.</p>
    ...
    <div className="wiki-modal-overlay" onClick={onClose}>
      <div className="wiki-modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="wiki-header">
          ...
          <button className="wiki-close-btn" onClick={onClose} title={t('Закрыть', 'Close')} aria-label={t('Закрыть', 'Close')}><IconGlyph icon={mkIcons.close} /></button>
        </div>
