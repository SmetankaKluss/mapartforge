    ...
    <div className="gif-overlay" onClick={(e) => { if (e.target === e.currentTarget && !isExporting) onClose(); }}>
      <div className="gif-modal">
        <div className="gif-header">
          ...
          {!isExporting && (
            <button className="gif-close" onClick={onClose} aria-label="Закрыть"><IconGlyph icon={mkIcons.close} /></button>
          )}
        </div>
        ...
        <div className="gif-actions">
          {isExporting ? (
            ...
            >
              <IconGlyph icon={mkIcons.export} /> Экспорт {totalSelected} кадров (.dat ZIP)
            </button>
            {onOpenAsProject && (
              <button
              ...
              >
                <IconGlyph icon={mkIcons.projectEditor} /> Открыть как проект ({totalSelected} кадров)
              </button>
            )}
          </>)}
        </div>
