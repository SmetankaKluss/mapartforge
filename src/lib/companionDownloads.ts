...
const COMPANION_MOD_DOWNLOAD_REV = '20260913-companion-0-14-1';

export const COMPANION_MOD_VERSION_OPTIONS = [
  {
    minecraftVersion: '26.2',
    badge: 'Java 25',
    href: `/downloads/mod/mapkluss-companion-26.2-0.14.1.jar?v=${COMPANION_MOD_DOWNLOAD_REV}`,
    filename: 'mapkluss-companion-26.2-0.14.1.jar',
  },
  {
    minecraftVersion: '1.21.11',
    badge: 'Java 21',
    href: `/downloads/mod/mapkluss-companion-1.21.11-0.14.1.jar?v=${COMPANION_MOD_DOWNLOAD_REV}`,
    filename: 'mapkluss-companion-1.21.11-0.14.1.jar',
  },
  {
    minecraftVersion: '1.21.8',
    badge: 'Java 21',
    href: `/downloads/mod/mapkluss-companion-1.21.8-0.14.1.jar?v=${COMPANION_MOD_DOWNLOAD_REV}`,
    filename: 'mapkluss-companion-1.21.8-0.14.1.jar',
  },
  {
    minecraftVersion: '1.21.4',
    badge: 'Java 21',
    href: `/downloads/mod/mapkluss-companion-1.21.4-0.14.1.jar?v=${COMPANION_MOD_DOWNLOAD_REV}`,
    filename: 'mapkluss-companion-1.21.4-0.14.1.jar',
  },
] as const;
