...
export function CompareView({
  ...
  width, height, scale, viewScale = scale, showGrid, splitPos, onSplitPosChange,
}: CompareViewProps) {
  const { t } = useLocale();
  ...
  return (
    <div ref={containerRef} className="split-canvas-container">
      ...
      <canvas ref={leftRef} className="map-canvas" style={{ width: width * viewScale, height: height * viewScale }} />
      ...
      {rightData && (
        ...
        >
          <canvas ref={rightRef} className="map-canvas" style={{ width: width * viewScale, height: height * viewScale }} />
        </div>
      )}
